    ...
    <div class="parent1">
        ...
        <div class="box-left-sabad">
            <div class="Sabad_Box_Left">
                ...
                <div class="div-btn">
                    <button class="btn-box-left-sabad" onclick="taeid()" id="taeid">
                        <p class="txt-btn-box-left-Sabad">تایید نهائی</p>
                    </button>
                </div>
            <?php
                } else {
